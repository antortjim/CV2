...
\usepackage[backend=biber,doi=false, isbn=false, url=false, style=numeric,sorting=none,citestyle=numeric-comp,maxnames=1,minnames=1]{biblatex}
...
\begin{figure}[!h]
 ...
 \begin{minipage}[r]{0.50\textwidth}
   ...
   PhD student at Liu Lab @ VIB-KU Leuven Center for Brain \& Disease Research studying social sleep in \textit{Drosophila}
...
I am interested in studying the behavior and sleep of \textit{Drosophila}. In my research I try to understand how sleep develops in a context as natural as possible, including social interactions with other individuals. In order to model this, I built an apparatus where I track sleep patterns in groups of freely interacting individuals over a full day, and now I use to unravel sleep synchronization mechanisms.}
